...
export default function ProductBreadcrumb({ product, category }) {
  ...
  return (
    <nav aria-label="Breadcrumb" className="pt-4 pb-2 bg-white">
      <div className="w-full max-w-[1600px] mx-auto px-4 lg:px-8">
        <ol className="flex flex-wrap items-center gap-y-1 gap-x-2 text-[11px] sm:text-[13px] lg:text-sm font-medium text-gray-500">
          <li>
