...
export default function BrandStory({ data, ...settings }) {
    ...
    <section className="py-24 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center`}>
          <div className={`${reverse.desktop ? 'order-1 lg:order-2' : 'order-2 lg:order-1'}`}>
          ...
          <div className={`${reverse.desktop ? 'order-2 lg:order-1' : 'order-1 lg:order-2'}`}>
