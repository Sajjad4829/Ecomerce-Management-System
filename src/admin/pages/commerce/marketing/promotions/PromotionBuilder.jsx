    ...
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-text-primary">{isEditing ? 'Edit Promotion' : 'Create Promotion'}</h1>
          </div>
        </div>
        <button 
          onClick={handleSave}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-surface rounded-xl border border-border shadow-sm p-6 space-y-4">
            <h2 className="font-bold text-text-primary mb-4">Promotion Details</h2>
            <div>
              <label className="block text-sm font-medium text-text-secondary mb-1">Promotion Name</label>
              <input 
                type="text" 
                name="name"
                value={formData.name}
          ...
          <div className="bg-surface rounded-xl border border-border shadow-sm p-6 space-y-4">
            <h2 className="font-bold text-text-primary mb-4">Eligibility Rules</h2>
            <div className="grid grid-cols-2 gap-4">
              <div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
               <p className="text-sm font-medium text-text-secondary mb-2">Customer Eligibility (Mock)</p>
