    ...
    <div className="flex flex-col min-h-[calc(100vh-theme(spacing.20))] pb-24">
      <div className="sticky top-0 z-20 bg-[#F7F5F2] pt-4 pb-4 border-b border-black/5 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-4">
          <Link to="/admin/seo/entities" className="p-2 bg-white border border-black/10 rounded-lg text-gray-500 hover:text-black hover:border-black/20 transition-all shadow-sm">
            <FiArrowLeft size={18} />
          </Link>
          <div>
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 bg-gray-200 text-gray-700 text-[10px] font-bold uppercase tracking-wider rounded">Product</span>
            </div>
            <h1 className="text-xl font-serif font-bold text-[#1A1A1A] mt-0.5">
              Oasis Lounge Chair
            </h1>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto w-full mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl border border-black/5 shadow-sm overflow-hidden">
              ...
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-4 text-sm font-medium transition-colors ${
                    activeTab === tab.id ? 'text-[#1A1A1A] border-b-2 border-[#1A1A1A]' : 'text-gray-500 hover:bg-gray-50'
                  }`}
                >
            ...
            <div className="p-8">
                ...
                <div className="space-y-6">
                  <div>
                    <div className="flex justify-between items-end mb-2">
                      <label className="block text-xs font-mono font-bold text-gray-500 uppercase">SEO Title</label>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-2">Optimal length is 50-60 characters.</p>
                  </div>

                  <div>
                    <div className="flex justify-between items-end mb-2">
                      <label className="block text-xs font-mono font-bold text-gray-500 uppercase">Meta Description</label>
                    ...
                    <textarea 
                      ...
                      rows={3}
                    />
                    <p className="text-xs text-gray-500 mt-2">Optimal length is 150-160 characters.</p>
                  </div>

                  <div>
                    <label className="block text-xs font-mono font-bold text-gray-500 uppercase mb-2">URL Slug</label>
                    <div className="flex items-center">
                      <span className="px-4 py-2.5 bg-gray-100 border border-transparent rounded-l-lg text-sm text-gray-500 shrink-0">
                      ...
                      <input 
                        ...
                        className="w-full px-4 py-2.5 bg-[#F7F5F2] border-transparent rounded-r-lg focus:outline-none focus:ring-2 focus:ring-black/20 text-sm font-medium text-[#1A1A1A]"
                      />
                    </div>
                  </div>

                  <div>
                    <label className="block text-xs font-mono font-bold text-gray-500 uppercase mb-2">Focus Keyword</label>
                    <input 
                      type="text" 
              ...
              {activeTab === 'advanced' && (
                <div className="space-y-6">
                  <div>
                    <label className="block text-xs font-mono font-bold text-gray-500 uppercase mb-2">Canonical URL</label>
                    <input 
                      type="text" 
                      ...
                      className="w-full px-4 py-2.5 bg-[#F7F5F2] border-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-black/20 text-sm font-medium text-[#1A1A1A]"
                    />
                    <p className="text-xs text-gray-500 mt-2">Leave blank to default to the current URL.</p>
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <label className="flex items-center justify-between p-4 bg-[#F7F5F2] rounded-xl border border-black/5 cursor-pointer">
                      <div>
                        <span className="text-sm font-bold text-[#1A1A1A] block">Index</span>
                        <span className="text-xs text-gray-500">Allow search engines to index this page.</span>
                      </div>
                      <input 
                        type="checkbox" 
                    ...
                    <label className="flex items-center justify-between p-4 bg-[#F7F5F2] rounded-xl border border-black/5 cursor-pointer">
                      <div>
                        <span className="text-sm font-bold text-[#1A1A1A] block">Follow</span>
                        <span className="text-xs text-gray-500">Allow search engines to follow links.</span>
                      </div>
                      <input 
                        type="checkbox" 
              ...
              {activeTab === 'social' && (
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-xs font-mono font-bold text-gray-500 uppercase mb-2">OG Title</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="block text-xs font-mono font-bold text-gray-500 uppercase mb-2">OG Description</label>
                    <textarea 
                  ...
                  <div>
                    <label className="block text-xs font-mono font-bold text-gray-500 uppercase mb-2">OG Image</label>
                    <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 flex flex-col items-center justify-center text-center hover:bg-gray-50 transition-colors cursor-pointer bg-[#F7F5F2]">
                      ...
                      <p className="text-sm font-bold text-[#1A1A1A]">Select Social Image</p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-black/5 shadow-sm p-6">
            <h3 className="text-[10px] font-mono font-bold text-gray-500 uppercase tracking-wider mb-4">SEO Score</h3>
            
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 rounded-full border-4 border-green-500 flex items-center justify-center">
                <span className="text-xl font-bold text-[#1A1A1A]">85</span>
              </div>
              <div>
                <p className="text-sm font-bold text-[#1A1A1A]">Good</p>
                <p className="text-xs text-gray-500">Your SEO is well optimized.</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2 text-sm">
                ...
                <span className="text-gray-700">Title length is optimal.</span>
              </div>
              <div className="flex items-start gap-2 text-sm">
                <FiCheck className="text-green-500 shrink-0 mt-0.5" />
                <span className="text-gray-700">Description length is optimal.</span>
              </div>
              <div className="flex items-start gap-2 text-sm">
                <FiCheck className="text-green-500 shrink-0 mt-0.5" />
                <span className="text-gray-700">Focus keyword appears in title.</span>
              </div>
              <div className="flex items-start gap-2 text-sm">
                <FiAlertCircle className="text-amber-500 shrink-0 mt-0.5" />
                <span className="text-gray-700">Focus keyword not in slug.</span>
              </div>
            </div>
          </div>
