...
export default function AuditDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-24">
      <div>
        <h1 className="text-2xl font-serif font-bold text-stone-900">Audit & Compliance Center</h1>
        <p className="text-sm text-stone-500 mt-1">Monitor system activity, access controls, and security events</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm">
          ...
          <p className="text-2xl font-bold text-stone-900">{highRiskEvents.length}</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm">
          ...
          <p className="text-2xl font-bold text-stone-900">{failedEvents.length}</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-stone-200 shadow-sm">
          ...
          <p className="text-2xl font-bold text-stone-900">12 <span className="text-xs text-stone-400 font-normal">(Placeholder)</span></p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl border border-stone-200 shadow-sm p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/admin/audit/logs" className="text-sm text-stone-600 hover:text-stone-900">View All</Link>
          </div>
          {loading ? (
        ...
        <div className="bg-white rounded-xl border border-stone-200 shadow-sm p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/admin/audit/logs?severity=High" className="text-sm text-stone-600 hover:text-stone-900">View All</Link>
          </div>
          {loading ? (
            <div className="animate-pulse h-40 bg-stone-100 rounded-lg"></div>
          ) : (
