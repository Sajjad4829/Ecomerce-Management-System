  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-serif text-neutral-900">Membership Tiers</h1>
          <p className="text-sm text-neutral-500 mt-1">Configure customer tiers and benefits</p>
        </div>
        <Link to="new" className="px-4 py-2 bg-neutral-900 text-white rounded-md hover:bg-neutral-800 transition-colors flex items-center gap-2 text-sm font-medium">
          ...
          <tbody className="divide-y divide-neutral-200">
            {tiers.map(tier => (
              <tr key={tier.id} className="hover:bg-neutral-50">
                <td className="px-6 py-4 font-medium text-neutral-900">{tier.name}</td>
                <td className="px-6 py-4 text-neutral-600">{tier.qualification}</td>
                <td className="px-6 py-4 text-neutral-600">{tier.benefits}</td>
