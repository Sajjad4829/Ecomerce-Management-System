...
export const LoyaltyDashboard = () => (
  <div className="space-y-6 max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div className="bg-white p-5 rounded-lg border border-neutral-200 shadow-sm"><div className="text-sm text-neutral-500">Total Members</div><div className="text-2xl font-serif text-neutral-900 mt-1">1,245</div></div>
      <div className="bg-white p-5 rounded-lg border border-neutral-200 shadow-sm"><div className="text-sm text-neutral-500">Active VIPs</div><div className="text-2xl font-serif text-neutral-900 mt-1">42</div></div>
      <div className="bg-white p-5 rounded-lg border border-neutral-200 shadow-sm"><div className="text-sm text-neutral-500">Points Issued</div><div className="text-2xl font-serif text-neutral-900 mt-1">45,000</div></div>
      <div className="bg-white p-5 rounded-lg border border-neutral-200 shadow-sm"><div className="text-sm text-neutral-500">Rewards Redeemed</div><div className="text-2xl font-serif text-neutral-900 mt-1">124</div></div>
    </div>
