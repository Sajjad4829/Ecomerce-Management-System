  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-serif font-bold text-text-primary">Order Analytics</h1>
          <p className="text-text-muted text-sm mt-1">Order volume and fulfillment status</p>
        </div>
