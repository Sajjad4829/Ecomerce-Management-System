    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-4">
          <button onClick={() => navigate('/admin/analytics/reports')} className="text-text-muted hover:text-black">
          ...
          <input 
            ...
            className="text-2xl font-serif font-bold text-text-primary border-none focus:outline-none focus:ring-0 bg-transparent"
          />
        </div>
        <div className="flex items-center gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <select 
              ...
              className="w-full px-4 py-2 bg-surface border border-black/10 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-black/20"
            >
          ...
          <div>
            <label className="block text-sm font-medium text-text-secondary mb-2">Dimension</label>
            <select 
          ...
          <div>
            <label className="block text-sm font-medium text-text-secondary mb-2">Visualization Type</label>
            <select 
