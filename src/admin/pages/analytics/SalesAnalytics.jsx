  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-serif font-bold text-[#1A1A1A]">Sales Analytics</h1>
          <p className="text-gray-500 text-sm mt-1">Detailed revenue and sales performance</p>
        </div>
