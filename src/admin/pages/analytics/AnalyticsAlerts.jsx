  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-serif font-bold text-text-primary">Analytics Alerts</h1>
          <p className="text-text-muted text-sm mt-1">Configure automated anomaly detection</p>
        </div>
      ...
      <div className="bg-surface rounded-xl border border-black/5 shadow-sm p-12 text-center text-text-muted">
        <FiBell className="w-12 h-12 mx-auto mb-4 text-text-muted" />
