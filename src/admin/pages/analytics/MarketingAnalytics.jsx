    ...
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-text-muted text-sm mt-1">Campaign and promotion performance</p>
        </div>
        ...
        <div className="bg-surface rounded-xl border border-black/5 shadow-sm overflow-hidden flex flex-col" style={{ minHeight: '400px' }}>
          ...
          <DataTable 
            ...
            columns={[
              ...
              { key: 'orders', label: 'Uses' },
              { key: 'discount', label: 'Total Discount', render: (val) => new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(val) },
              { key: 'revenue', label: 'Revenue Generated', render: (val) => new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(val) },
            ]}
          />
        </div>
