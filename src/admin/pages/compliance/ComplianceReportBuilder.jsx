  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-24">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-serif font-bold text-stone-900">Build Report</h1>
          <p className="text-sm text-stone-500 mt-1">Configure criteria for a custom compliance report</p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => navigate('/admin/compliance/reports')} className="flex items-center gap-2 px-6 py-2 bg-stone-900 text-white rounded-lg hover:bg-stone-800 font-medium">
            <FiSave /> Save Report
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-stone-200 shadow-sm p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-stone-100">
          <div>
            <label className="block text-sm font-medium text-stone-700 mb-2">Event Types</label>
          ...
          <div>
            ...
            <select className="w-full px-4 py-2 border border-stone-200 rounded-lg text-sm focus:ring-1 focus:ring-stone-900 focus:outline-none mb-4">
            ...
            <label className="block text-sm font-medium text-stone-700 mb-2">Target Modules</label>
