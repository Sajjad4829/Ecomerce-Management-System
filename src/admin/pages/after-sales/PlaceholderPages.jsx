...
export const AfterSalesDashboard = () => (
  <div className="space-y-6 max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div className="bg-white p-5 rounded-lg border border-neutral-200 shadow-sm"><div className="text-sm text-neutral-500">Open Returns</div><div className="text-2xl font-serif text-neutral-900 mt-1">12</div></div>
      <div className="bg-white p-5 rounded-lg border border-neutral-200 shadow-sm"><div className="text-sm text-neutral-500">Pending RMAs</div><div className="text-2xl font-serif text-neutral-900 mt-1">5</div></div>
      <div className="bg-white p-5 rounded-lg border border-neutral-200 shadow-sm"><div className="text-sm text-neutral-500">Active Repairs</div><div className="text-2xl font-serif text-neutral-900 mt-1">8</div></div>
      <div className="bg-white p-5 rounded-lg border border-neutral-200 shadow-sm"><div className="text-sm text-neutral-500">Warranty Claims</div><div className="text-2xl font-serif text-neutral-900 mt-1">3</div></div>
    </div>
