  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-surface p-6 rounded-lg border border-neutral-200 shadow-sm flex flex-col items-center justify-center text-center">
        ...
        <div className="bg-surface p-6 rounded-lg border border-amber-200 shadow-sm flex flex-col items-center justify-center text-center bg-warning-soft">
          <AlertTriangle className="w-8 h-8 text-amber-500 mb-3" />
          <h3 className="text-2xl font-serif text-amber-900">3</h3>
          <p className="text-sm text-warning">Needs Review</p>
        </div>
      ...
      <div className="bg-surface rounded-lg border border-neutral-200 shadow-sm p-8 text-center text-neutral-500">
