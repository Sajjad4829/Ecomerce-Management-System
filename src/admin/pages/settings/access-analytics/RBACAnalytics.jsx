  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-serif font-bold text-[#1A1A1A]">Access Analytics</h1>
          <p className="text-gray-500 text-sm mt-1">System-wide access overview</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map(stat => {
          ...
          return (
            <div key={stat.label} className="bg-white p-6 rounded-xl border border-black/5 shadow-sm">
              <div className="flex items-center gap-4 mb-2">
                <div className={`w-10 h-10 rounded-full bg-${stat.color}-50 flex items-center justify-center text-${stat.color}-600`}>
                  <Icon />
                </div>
                <h3 className="font-medium text-gray-500">{stat.label}</h3>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-6 rounded-xl border border-black/5 shadow-sm h-64 flex items-center justify-center text-gray-500">
