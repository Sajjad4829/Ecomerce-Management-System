  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-serif font-bold text-text-primary">Invite Staff Member</h1>
          <p className="text-text-muted text-sm mt-1">Send an invitation to join the admin team</p>
        </div>
      ...
      <div className="bg-surface rounded-xl border border-black/5 shadow-sm p-6 space-y-6">
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <input type="text" className="w-full px-4 py-2 border border-border-hover rounded-lg focus:ring-black focus:border-black" />
          </div>
          <div>
        ...
        <div>
          ...
          <input type="email" className="w-full px-4 py-2 border border-border-hover rounded-lg focus:ring-black focus:border-black" />
        </div>

        <div>
          <label className="block text-sm font-medium text-text-secondary mb-2">Department</label>
          <select className="w-full px-4 py-2 border border-border-hover rounded-lg focus:ring-black focus:border-black">
        ...
        <div className="pt-6 border-t border-black/10">
          ...
          <div className="space-y-3">
            {['Super Admin', 'Catalog Manager', 'Inventory Manager', 'Customer Support'].map(role => (
              <label key={role} className="flex items-center gap-3 p-4 border border-border rounded-lg hover:bg-background cursor-pointer">
                <input type="radio" name="role" className="w-4 h-4 text-black focus:ring-black" />
                <div>
                  <div className="font-medium">{role}</div>
                  <div className="text-sm text-text-muted">Standard system role</div>
                </div>
              </label>
            ))}
          </div>
