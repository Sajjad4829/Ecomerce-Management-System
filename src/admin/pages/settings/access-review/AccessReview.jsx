  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-serif font-bold text-text-primary">Access Review</h1>
          <p className="text-text-muted text-sm mt-1">Audit staff permissions and high-risk access</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-surface p-6 rounded-xl border border-black/5 shadow-sm">
          <div className="flex items-center gap-4 mb-2">
            ...
            <h3 className="font-medium text-text-muted">Pending Reviews</h3>
          </div>
        ...
        <div className="bg-surface p-6 rounded-xl border border-black/5 shadow-sm">
          <div className="flex items-center gap-4 mb-2">
            ...
            <h3 className="font-medium text-text-muted">High Risk Roles</h3>
          </div>
            ...
            { key: 'risk', label: 'Risk Level', render: (val, row) => {
              ...
              return (
                <span className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-xs font-medium ${
                  isHigh ? 'bg-danger-soft text-red-700' : 'bg-success-soft text-success'
                }`}>
