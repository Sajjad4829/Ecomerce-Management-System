  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-serif font-bold text-[#1A1A1A]">Security Policies</h1>
          <p className="text-gray-500 text-sm mt-1">Configure enterprise security and authentication rules</p>
        </div>
      ...
      <div className="space-y-6">
          ...
          <div className="space-y-4">
            <label className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">Enforce MFA for all staff accounts</div>
              </div>
            </label>
            <div className="pt-4 border-t border-black/10">
              <label className="block text-sm font-medium text-gray-700 mb-2">Password Expiration</label>
              <select className="w-full md:w-1/2 px-4 py-2 border border-gray-300 rounded-lg">
        ...
        <div className="bg-white rounded-xl border border-black/5 shadow-sm p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Idle Session Timeout</label>
              <select className="w-full md:w-1/2 px-4 py-2 border border-gray-300 rounded-lg">
