...
export default function NavigationPreview({ device, viewMode }) {
  ...
  return (
    <div className="bg-gray-100 rounded-xl border border-black/5 flex-1 relative overflow-hidden flex justify-center h-full">
      {/* Canvas Area */}
      <div className={cn(
        "bg-white h-full shadow-2xl transition-all duration-300 flex flex-col border-x border-black/5 relative",
        getContainerWidth()
      )}>
        ...
        {device === 'mobile' ? (
          ...
          <div className="flex-1 flex flex-col bg-white overflow-hidden">
             ...
             <div className="p-4 border-b border-black/5">
                <div className="bg-gray-100 rounded-md px-3 py-2 flex items-center gap-2 text-gray-500">
                   <FiSearch size={14} />
                   <span className="text-sm">Search...</span>
                </div>
             </div>
             <div className="flex-1 overflow-y-auto">
                <div className="flex justify-between items-center p-4 border-b border-black/5 hover:bg-gray-50 cursor-pointer">
          ...
          <div className="flex-1 bg-[#F7F5F2] flex flex-col relative overflow-hidden">
             <header className="bg-white/90 backdrop-blur border-b border-black/5 px-6 py-4 flex items-center justify-between shrink-0 sticky top-0 z-10">
                ...
                <nav className="hidden md:flex items-center gap-6 text-sm font-medium h-full">
                  <div className={cn(
                    ...
                    viewMode === 'mega-menu' ? "text-[#A69076]" : "text-[#1A1A1A] hover:text-[#A69076]"
                  )}>
                    Living Room
                    {/* Active Indicator */}
                    {viewMode === 'mega-menu' && (
                  ...
                  <span className="text-[#1A1A1A] hover:text-[#A69076] cursor-pointer transition-colors">Bedroom</span>
                  <span className="text-[#1A1A1A] hover:text-[#A69076] cursor-pointer transition-colors">Dining</span>
                  <span className="text-[#1A1A1A] hover:text-[#A69076] cursor-pointer transition-colors">Collections</span>
                  <span className="text-gray-400 cursor-not-allowed">About Us</span>
                </nav>
             ...
             {viewMode === 'mega-menu' && device !== 'mobile' && (
                <div className="absolute top-[61px] left-0 right-0 bg-white shadow-xl border-b border-black/5 z-20 animate-in slide-in-from-top-2">
                   <div className="max-w-7xl mx-auto px-6 py-8 flex gap-12">
                      <div className="flex gap-12 flex-1">
                         <div className="space-y-4">
                            <h4 className="font-bold text-sm text-[#1A1A1A]">Sofas & Sectionals</h4>
                         ...
                         <div className="space-y-4">
                            <h4 className="font-bold text-sm text-[#1A1A1A]">Chairs</h4>
                            <ul className="space-y-2 text-sm text-gray-500">
                         ...
                         <div className="space-y-4">
                            <h4 className="font-bold text-sm text-[#1A1A1A]">Tables</h4>
                            <ul className="space-y-2 text-sm text-gray-500">
                      ...
                      {/* Promotional Block */}
                      <div className="w-80 shrink-0 bg-gray-50 p-4 rounded-xl">
                         <div className="aspect-[4/3] bg-gray-200 mb-4 rounded-lg"></div>
                         <h4 className="font-bold text-[#1A1A1A] mb-1">Summer Collection</h4>
                         <p className="text-xs text-gray-500 mb-3">Explore our new premium outdoor living sets.</p>
             ...
             {/* Dummy Page Content */}
             <div className="flex-1 p-8 text-center text-gray-400 flex flex-col items-center justify-center opacity-30">
