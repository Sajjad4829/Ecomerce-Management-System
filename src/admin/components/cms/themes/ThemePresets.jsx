        ...
        <div key={preset.id} className={cn(
          ...
          <div className="w-full aspect-[16/9] bg-gray-100 relative">
             {preset.image ? (
               ...
               <div className="w-full h-full flex items-center justify-center text-gray-300 bg-background">No Preview</div>
             )}
             ...
             <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                <button className="w-10 h-10 bg-surface rounded-full flex items-center justify-center text-text-primary hover:scale-110 transition-transform shadow-lg" title="Preview Theme">
                  <FiEye size={18} />
                </button>
             </div>
          </div>
