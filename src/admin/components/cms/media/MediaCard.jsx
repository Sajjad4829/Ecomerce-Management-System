...
export default function MediaCard({ asset, isSelected, onSelect, onPreview, onToggleFavorite }) {
  ...
  return (
    <div 
      ...
      className={cn(
        "group relative bg-white rounded-xl border border-black/5 shadow-xs hover:shadow-md transition-all duration-200 overflow-hidden cursor-pointer flex flex-col",
    ...
    >
      ...
      <div className="relative aspect-[4/3] bg-gray-100 overflow-hidden flex items-center justify-center">
        {isDoc ? (
          ...
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
              <div className="w-10 h-10 rounded-full bg-white/90 text-[#1A1A1A] flex items-center justify-center shadow-lg">
                <FiVideo size={18} />
              </div>
            </div>
          </div>
        ...
        <button
          ...
          className={cn(
            ...
            isSelected 
              ...
              : "bg-white/90 border-black/20 text-transparent opacity-0 group-hover:opacity-100 hover:border-black"
          )}
        >
        ...
        <button
          ...
          className={cn(
            "absolute top-2.5 right-2.5 p-1.5 rounded-md bg-white/90 backdrop-blur-xs transition-all z-10",
            asset.favorite 
      ...
      <div className="p-3 flex flex-col justify-between flex-1 bg-white">
        <div>
          <h4 className="text-xs font-bold text-[#1A1A1A] truncate tracking-tight" title={asset.title}>
            {asset.title}
          </h4>
        ...
        <div className="mt-2.5 pt-2 border-t border-black/5 flex items-center justify-between text-[10px] text-gray-500 font-mono">
