export default function FeaturesPreview() {
  ...
  return (
    <div className="py-20 px-8 md:px-16 bg-[#F7F5F2]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        {features.map((feature, idx) => (
          <div key={idx} className="text-center">
            ...
            <h3 className="text-lg font-serif font-bold text-[#1A1A1A] mb-3">{feature.title}</h3>
            <p className="text-sm text-gray-600 leading-relaxed max-w-xs mx-auto">{feature.desc}</p>
          </div>
        ))}
      </div>
    </div>
