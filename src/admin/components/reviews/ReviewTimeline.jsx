...
import { FiCheckCircle, FiClock, FiXCircle, FiMessageSquare } from 'react-icons/fi';
...
export default function ReviewTimeline({ events }) {
  ...
  const getIcon = (status) => {
    switch (status) {
      case 'Pending Moderation': return <FiClock size={14} />;
      case 'Published': return <FiCheckCircle size={14} />;
      case 'Rejected': case 'Hidden': return <FiXCircle size={14} />;
      case 'Replied': return <FiMessageSquare size={14} />;
