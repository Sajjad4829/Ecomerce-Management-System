        ...
        >
          ...
          <div className="relative h-48 bg-stone-100 overflow-hidden cursor-pointer">
            ...
            <div className="absolute top-4 right-4 flex flex-col gap-2 items-end">
              ...
              <span className="px-2 py-1 bg-white/90 backdrop-blur-sm text-stone-700 text-[10px] font-mono font-bold uppercase rounded shadow-sm">
                {collection.type}
              </span>
            </div>
          </div>
          ...
          <div className="p-5 flex-1 flex flex-col">
            ...
            <p className="text-sm text-stone-600 line-clamp-2 mt-2 flex-1">
            ...
            <div className="mt-6 pt-4 border-t border-stone-100 flex items-center justify-between">
              <div className="flex flex-col">
                <span className="text-[10px] text-stone-400 font-mono uppercase tracking-wider">Products</span>
                <span className="font-semibold text-stone-900">{collection.productCount}</span>
              </div>
              
              {collection.status === 'scheduled' && (
                <div className="flex flex-col items-end">
                  <span className="text-[10px] text-stone-400 font-mono uppercase tracking-wider">Launches</span>
          ...
          {/* Action Footer */}
          <div className="bg-stone-50 border-t border-stone-100 p-3 flex justify-between items-center opacity-0 group-hover:opacity-100 transition-opacity duration-200">
            <button 
              onClick={(e) => { e.stopPropagation(); onPreview(collection); }}
              className="px-3 py-1.5 flex items-center gap-2 text-xs font-medium text-stone-600 hover:text-stone-900 hover:bg-stone-200 rounded transition-colors"
            >
