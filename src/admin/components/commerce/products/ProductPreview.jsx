          ...
          >
            <div className="flex items-center justify-between p-4 border-b border-stone-100 bg-background/50">
              <div className="flex items-center gap-2">
                <h2 className="font-serif font-bold text-text-primary text-lg">Quick Preview</h2>
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="aspect-[4/3] bg-stone-100 relative border-b border-border">
              ...
              <div className="p-6 space-y-6">
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <p className="font-mono text-xs text-text-muted uppercase">{product.sku}</p>
                    <p className="font-medium text-text-primary">${product.price.toLocaleString()}</p>
                  </div>
                  <h1 className="font-serif text-2xl font-bold text-text-primary">{product.name}</h1>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-stone-100">
                  <div>
                    <p className="text-[10px] font-mono font-bold text-text-muted uppercase">Category</p>
                    <p className="text-sm text-text-primary mt-0.5">{product.category}</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-mono font-bold text-text-muted uppercase">Collection</p>
                    <p className="text-sm text-text-primary mt-0.5">{product.collection}</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-mono font-bold text-text-muted uppercase">Inventory</p>
                    <p className="text-sm text-text-primary mt-0.5">{product.stock} Units</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-mono font-bold text-text-muted uppercase">Last Updated</p>
                    <p className="text-sm text-text-primary mt-0.5">{product.updatedAt}</p>
                  </div>
                </div>
              </div>
            </div>
