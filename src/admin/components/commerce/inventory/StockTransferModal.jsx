      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          <div className="flex items-center justify-between p-6 border-b border-black/5 shrink-0 bg-background">
            <div>
              <h2 className="text-xl font-serif font-bold text-text-primary">Transfer Stock</h2>
          ...
          <div className="p-6 overflow-y-auto">
            <div className="mb-6 flex items-center gap-4">
              <div className="flex-1 p-4 bg-background border border-gray-100 rounded-xl text-center">
                <p className="text-[10px] font-mono font-bold text-text-muted uppercase mb-1">Source</p>
                <p className="text-sm font-bold text-text-primary">{item.warehouse}</p>
                <p className="text-xs text-success mt-1">Available: {item.onHand - item.reserved}</p>
              </div>
              <FiArrowRight className="text-text-muted shrink-0" size={24} />
              <div className="flex-1 p-4 bg-background border border-black/10 rounded-xl">
                <p className="text-[10px] font-mono font-bold text-text-muted uppercase mb-1">Destination</p>
                <select 
                  value={destination}
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-xs font-mono font-bold text-text-muted uppercase mb-2">Quantity to Transfer</label>
                <input 
                  type="number" 
                  value={quantity}
              ...
              <div>
                <label className="block text-xs font-mono font-bold text-text-muted uppercase mb-2">Transfer Notes</label>
                <textarea 
                  value={notes}
