  ...
  return (
    <div className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 flex items-start gap-4">
        <FiCode className="text-primary mt-1" size={24} />
        <div>
      ...
      <SEOFieldGroup label="Custom JSON-LD (Advanced)" description="Add custom structured data to override or append to the default schema.">
        <textarea
          ...
          rows={8}
          className="w-full font-mono text-sm p-3 bg-background border border-border rounded-lg focus:outline-none focus:border-primary"
        />
      </SEOFieldGroup>
    </div>
  );
