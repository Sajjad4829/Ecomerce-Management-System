...
const INITIAL_SECTIONS = [
  ...
  { id: 'lib-section-builder', type: 'SECTION_BUILDER', name: 'Section Builder', category: 'FORMS', description: 'Drag-and-drop form and layout builder', icon: 'FiLayout', defaultContent: { layout: [] }, defaultSettings: {}, status: 'Active' },
];
